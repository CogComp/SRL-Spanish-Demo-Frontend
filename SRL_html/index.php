	...
	<form id="demoForm" name="demoForm" onSubmit="return false;">
		<div class="w3-container">
			<div class="w3-left">
				...
				-->
				<input class="w3-check annotator" type="checkbox" checked="checked" id="SRL" disabled="true">
			...
			<div class="w3-right">
				...
				<br>
				<select class="w3-select w3-pale-white w3-border" id="example" name="example" value="" onChange="javascript:newExampleSelect();" style="width:512px;">
...
<div id="senseFrame" class="w3-modal">
	<div id="senseFrameContainer" class="w3-modal-content w3-display-topright w3-margin">
		<div id="senseFrameTitle" class="w3-container">
			<span onclick="hideSenseFrame()" class="w3-button w3-light-gray w3-border w3-display-topright">&times;</span>
			<div id="senseFrameBody" class="w3-container">
				<p>Loading frame content...</p>
			<div>
      </div>
    </div>
</div>
