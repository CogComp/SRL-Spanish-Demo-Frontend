...
def processSRL(myTabularView,annjson):
    ...
    if "tokens" in annjson:
        ...
        '''
        myTabularView.addPredicateArgumentView(annjson,"SRL_MULTILINGUAL","SRL-Verb")
...
def doProcess(myTabularView, text=None, anns=None):
    ...
    if hash_value in cache_dic['spa'].keys():
        tokens, end_pos, annjsonSRL, cache_dic = cache.read(cache_dic, hash_value, lang='spa')
        ...
        cache_dic = cache.add(text,hash_value, tokens, end_pos, annjsonSRL, cache_dic, lang='spa')
